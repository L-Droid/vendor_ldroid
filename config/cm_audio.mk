...
ALARM_PATH := vendor/ldroid/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/ldroid/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/ldroid/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/ldroid/prebuilt/common/media/audio/ui
